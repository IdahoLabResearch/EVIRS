...
class mainRequestHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        eduimages = [tornado.web.StaticFileHandler.make_static_url(path="images/Education/ModelXAccident.png", settings=self.application.settings), 
                     tornado.web.StaticFileHandler.make_static_url(path="images/Education/ModelSAccident.png", settings=self.application.settings)]
